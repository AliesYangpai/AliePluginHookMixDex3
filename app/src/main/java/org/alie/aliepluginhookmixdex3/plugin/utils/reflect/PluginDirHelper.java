...
package org.alie.aliepluginhookmixdex3.plugin.utils.reflect;
...
/**
 * 插件目录结构
 * 基本目录： getBaseDir()    /data/data/com.HOST.PACKAGE/Plugin
 * 单个插件的基本目录：      /data/data/com.HOST.PACKAGE/Plugin
 * source_dir：apk存放路径    getPluginApkDi() /data/data/com.HOST.PACKAGE/Plugin/插件包名/apk/apk-1.apk
 * 数据目录： getPluginDataDir()    /data/data/com.HOST.PACKAGE/Plugin/插件包名/data/
 *  dex缓存目录：getPluginDalvikCacheDir()  /data/data/com.HOST.PACKAGE/Plugin/PLUGIN.PKG/dalvik-cache/
 * <p>
 */
